...
from inspection import enrich_with_inspection_features
...
ANCHOR_FEATURE_COLUMNS = ANCHOR_CATEGORICAL_COLUMNS + ANCHOR_NUMERICAL_COLUMNS
...
DELTA_CATEGORICAL_COLUMNS = ANCHOR_CATEGORICAL_COLUMNS
...
PROXY_DELTA_CATEGORICAL_COLUMNS = ANCHOR_CATEGORICAL_COLUMNS
...
def engineer_feature_frame(df: pd.DataFrame) -> pd.DataFrame:
    ...
    _ensure_columns(df, ["description", "extra_features", "body_type", "engine_capacity_cc"], pd.NA)
